...
TRANSLATION_MEMORY: List[TranslationEntry] = [
    ...
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_IMG_WIDTH, default="Img Width"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_IMG_WIDTH, default="Left/Right"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_IMG_HEIGHT, default="Img Height"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_IMG_HEIGHT, default="Up/Down"),
    TranslationEntry(
        id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_DOUBLE_HALVE_WIDTH, default="Double/Halve Width"
    ),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_DOUBLE_HALVE_WIDTH, default="Q/W"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_STEP_BY_BYTE, default="Step-By-Byte"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_STEP_BY_BYTE, default="CTRL+Up/Down"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_STEP_BY_ROW, default="Step-By-Row"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_STEP_BY_ROW, default="SHIFT+Up/Down"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_PIXEL_FORMAT, default="Pixel Format"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_PIXEL_FORMAT, default="Z/X"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_ENDIANESS, default="Endianess"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_ENDIANESS, default="E"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_SWIZZLING, default="Swizzling"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_SWIZZLING, default="K/L"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_COMPRESSION, default="Compression"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_COMPRESSION, default="O/P"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_RELOAD_IMG, default="Reload Img"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_RELOAD_IMG, default="Enter"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_ACTION_ZOOM, default="Zoom"),
    TranslationEntry(id=TranslationEntries.TRANSLATION_TEXT_CONTROLS_SHORTCUT_ZOOM, default="Mouse Wheel"),
]
