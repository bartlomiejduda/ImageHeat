...
SUPPORTED_SWIZZLING_TYPES: list[SwizzlingType] = [
    ...
    SwizzlingType(display_name="PS5", unique_id="ps5"),
    ...
    SwizzlingType(display_name="Nintendo Switch (4,16)", unique_id="nintendo_switch_4_16"),
...
SUPPORTED_COMPRESSION_TYPES: list[CompressionType] = [
    ...
    CompressionType(display_name="TGA RLE (reversed)", unique_id="rle_tga_reversed"),
...
class TranslationKeys(str, Enum):
    ...
    TRANSLATION_TEXT_CONTROLS_ACTION_STEP_BY_PAGE = "TRANSLATION_TEXT_CONTROLS_ACTION_STEP_BY_PAGE"
    TRANSLATION_TEXT_CONTROLS_SHORTCUT_STEP_BY_PAGE = "TRANSLATION_TEXT_CONTROLS_SHORTCUT_STEP_BY_PAGE"
    ...
    TRANSLATION_TEXT_POST_PROCESSING_CHANNELS = "TRANSLATION_TEXT_POST_PROCESSING_CHANNELS"
    TRANSLATION_TEXT_POST_PROCESSING_CHANNELS_ALL = "TRANSLATION_TEXT_POST_PROCESSING_CHANNELS_ALL"
    ...
    TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_UA = "TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_UA"
    TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_PTBR = "TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_PTBR"
    TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_ES = "TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_ES"
    TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_ZH = "TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_ZH"
    TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_SL = "TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_SL"
...
TRANSLATION_MEMORY: List[TranslationEntry] = [
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_START_OFFSET, default="Start Offset (Dec/Hex)"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_END_OFFSET, default="End Offset (Dex/Hex)"),
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_CONTROLS_ACTION_STEP_BY_PAGE, default="Step-By-Page"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_CONTROLS_SHORTCUT_STEP_BY_PAGE, default="PgUp/PgDn"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_CONTROLS_ACTION_PIXEL_FORMAT, default="Pixel Format"),
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_CONTROLS_SHORTCUT_PIXEL_FORMAT, default="R/T"),
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_CONTROLS_SHORTCUT_ENDIANESS, default="Y"),
    ...
    TranslationEntry(id=TranslationKeys.TRANSLATION_TEXT_OPTIONSMENU_LANGUAGE_SL, default="Slovenian"),
